...
Pet.create!(image:File.open("./public/images/mix.png"), content:'可愛い雑種の犬です', select_animal: 'dog', age: '0', gender: 'オス', current_location:'岡山市', prefecture:'岡山県', castrated: true, vaccinated: true, user_id: User.last.id)
#Pet.create!(image:, content:'可愛いポメラニアンです', select_animal: 'dog', age: '1', gender: 'メス', current_location:'仙台市', prefecture:'宮城県', castrated:true, vaccinated:true)
#Pet.create!(image:, content:'可愛い秋田犬です', select_animal: 'dog', age: '3', gender: 'オス', current_location:'浦安市', prefecture:'千葉県', castrated:true, vaccinated:true)
#Pet.create!(image:, content:'可愛い雑種の猫です', select_animal: 'cat', age: '5', gender: 'メス', current_location:'大津市', prefecture:'滋賀県', castrated:false, vaccinated:false)
#Pet.create!(image:, content:'可愛いさび猫です', select_animal: 'cat', age: '7', gender: 'オス', current_location:'高松市', prefecture:'香川県', castrated:true, vaccinated:true)
#Pet.create!(image:, content:'可愛いシャム猫です', select_animal: 'cat', age: '8', gender: 'メス', current_location:'那覇市', prefecture:'沖縄県', castrated:true, vaccinated:true)
